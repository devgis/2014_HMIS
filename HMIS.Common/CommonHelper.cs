...
namespace FYSOFT.HMIS.Common
{
    public class CommonHelper
    {
        ...
        public static void ShowMdiForm(Form MdiChildForm,Form MdiParentForm)
        {
            try
            {
            ...
            {
                MdiChildForm.Dispose();
                MessageBox.Show("加载出国了", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
